...
| # | Issue | 问题 | 状态 |
|---|-------|------|------|
| 1 | **ISS-009** | Entity 索引 — ~~完全空置~~ entity_recall 已实现（第4路检索），ISS-016 补齐 triple extraction | P1 **closed** |
...
| 9 | **ISS-011** | Recall 结果去重 — 返回的 top-K 含近似重复，浪费 context window | P2 closed |
| 10 | **ISS-012** | Importance 校准 — auto-extract importance 无上限，系统指令可得 0.9+ | P2 closed |
...
## ISS-009 [feature] [P1] [closed]
**标题**: Entity 索引 — ~~schema 已建但完全空置~~ 已实现 entity_recall + triple extraction
**发现日期**: 2026-04-08
**更新日期**: 2026-04-18
**关闭日期**: 2026-04-18
**发现者**: RustClaw + potato
